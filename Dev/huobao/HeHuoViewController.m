...
@implementation HeHuoViewController
@synthesize timer;
@synthesize line;
@synthesize huotable;
...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    {
        [self performSelectorOnMainThread:@selector(loginButtonClick:) withObject:nil waitUntilDone:NO];
...
-(void)loginButtonClick:(id)sender
{
    ...
    [loginDic setObject:beforeAccount forKey:@"userName"];
    [loginDic setObject:beforePaw forKey:@"password"];
...
-(void)requestSucceedWithStateID:(int)stateid withErrorStirng:(NSString *)errorString
{
    ...
    if (stateid == 1) {
        ...
        [self performSelector:@selector(initContactList) withObject:nil afterDelay:0];
    }
    else{
...
//    self.huotable.contentOffset = CGPointMake(0, -64.0f);
...
-(void)initContactList
{
    ...
    if ([sysbsModel.listContent count] == 0) {
...
- (void)doneLoadingTableViewData{
    ...
    switch (updateOption) {
        ...
        case 2:
        {
            huotable.contentOffset = CGPointMake(0, huotable.contentOffset.y - 64);
