...
- (void)viewDidLoad
{
    ...
    UIImageView *searchImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"add.png"]];
    ...
    UITapGestureRecognizer *searchTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(addFriendAction)];
    ...
    [rightBarItem setBackgroundImage:[UIImage imageNamed:@"add.png"] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
    [rightBarItem setBackgroundImage:[UIImage imageNamed:@"add.png"] forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
    [rightBarItem setTarget:self];
    rightBarItem.tag = 2;
    searchImage.tag = 2;
    [rightBarItem setAction:@selector(addFriendAction)];
