...
+ (NGTabBarItem *)itemWithTitle:(NSString *)title image:(UIImage *)image highlightedImage:(UIImage *)highlightedImage{
...
- (void)layoutSubviews {
    ...
    if (self.image != nil) {
        ...
        self.titleLabel.frame = CGRectMake(-1.5f, textTop, self.bounds.size.width, self.titleLabel.font.lineHeight);
    } else {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.image != nil) {
        ...
        if (_selectedByUser) {
            ...
            CGColorRef cgShadowColor = [[UIColor clearColor] CGColor];
            ...
            CGContextClipToMask(context, imageRect, [self.highlightedImage CGImage]);
