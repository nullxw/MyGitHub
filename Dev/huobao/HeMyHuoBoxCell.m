...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        titleLabel.frame = CGRectMake(iconX, iconY, labelW + 20, iconH);
        ...
        addressLabel.frame = CGRectMake(iconX + addressIcon.frame.size.width, timeLabel.frame.origin.y + timeLabel.frame.size.height + 5, labelW, iconH);
