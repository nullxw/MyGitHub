...
- (void)egoRefreshScrollViewDidScroll:(UIScrollView *)scrollView {
	...
	if (_state == EGOOPullRefreshLoading1) {
		...
		scrollView.contentInset = UIEdgeInsetsMake(offset, 0.0f, RefreshViewHight, 0.0f);
		...
		if (_state == EGOOPullRefreshPulling1 && scrollView.contentOffset.y + (scrollView.frame.size.height) < scrollView.contentSize.height + RefreshViewHight && scrollView.contentOffset.y > 64.0f && !_loading) {
			[self setState:EGOOPullRefreshNormal1];
...
- (void)egoRefreshScrollViewDidEndDragging:(UIScrollView *)scrollView {
	...
	if (scrollView.contentOffset.y + (scrollView.frame.size.height) > scrollView.contentSize.height + RefreshViewHight && !_loading) {
		...
		scrollView.contentInset = UIEdgeInsetsMake(64.0f, 0.0f, RefreshViewHight, 0.0f);
