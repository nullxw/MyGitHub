...
-(void)initView
{
    //    huoBoxTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height) style:UITableViewStylePlain];
    //    huoBoxTable.delegate = self;
    //    huoBoxTable.dataSource = self;
    ...
    //    self.huoBoxTable.tableFooterView = tableFooterView;
