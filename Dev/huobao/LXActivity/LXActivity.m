...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle shareButtonTitles:(NSArray *)shareButtonTitlesArray withShareButtonImagesName:(NSArray *)shareButtonImagesNameArray
{
    ...
    //生成LXActionSheetView
    UIImageView *bgImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"actionsheetBg.png"]];
    bgImage.userInteractionEnabled = YES;
    bgImage.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height, [UIScreen mainScreen].bounds.size.width, 0);
