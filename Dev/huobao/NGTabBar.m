...
- (void)createGradient {
    ...
    if ([baseColor respondsToSelector:@selector(getHue:saturation:brightness:alpha:)]) {
        ...
        //tabbar底部的玻璃质感的设置
        CGFloat a_Offset = 0.f;
        CGFloat b_Offset = 0.f;
        CGFloat c_Offset = 0.f;
//        CGFloat a_Offset = 0.2f;
//        CGFloat b_Offset = 0.15f;
//        CGFloat c_Offset = 0.1f;
        colors = [NSArray arrayWithObjects:
                  [UIColor colorWithHue:hue saturation:saturation brightness:brightness+a_Offset alpha:alpha],
                  [UIColor colorWithHue:hue saturation:saturation brightness:brightness+b_Offset alpha:alpha],
                  [UIColor colorWithHue:hue saturation:saturation brightness:brightness+c_Offset alpha:alpha],
                  baseColor, nil];
    } else {
        colors = [NSArray arrayWithObjects:
                  baseColor,
